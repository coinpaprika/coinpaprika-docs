...
description: "Real-time cryptocurrency data via WebSocket"
---

# CoinPaprika Streaming API

The CoinPaprika Streaming API provides real-time cryptocurrency ticker data via WebSocket connections. Get live price updates, market cap changes, and volume data for your favorite cryptocurrencies.
...
Subscribe to receive real-time updates for specific cryptocurrencies:
...
When subscribed, you'll receive real-time updates in this format:
...
- Email: [support@coinpaprika.com](mailto:support@coinpaprika.com)
